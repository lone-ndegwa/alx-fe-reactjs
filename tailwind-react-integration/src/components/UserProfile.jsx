function UserProfile() {
  return (
    <div className="bg-gray-100 p-2 sm:p-4 md:p-8 sm:max-w-xs md:max-w-sm mx-auto my-20 rounded-lg shadow-lg hover:shadow-xl text-center transition-shadow duration-300 ease-in-out">
      <img
